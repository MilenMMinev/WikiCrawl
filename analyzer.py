...
def main():
    ...
    # print(analyzer.reducedArticles[1])

    # print(min([len(x) for x in analyzer.reducedArticles[0].keys()]))

    # print(analyzer.tf("food", analyzer.reducedArticles[0]))
    # print(time.clock() - timeStamp)
